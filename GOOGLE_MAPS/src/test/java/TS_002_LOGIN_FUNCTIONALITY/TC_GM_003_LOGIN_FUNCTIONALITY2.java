...
public class TC_GM_003_LOGIN_FUNCTIONALITY2 extends GM_BASE_CLASS {
	@Test
	public void VALIDATE_INVALID_PASSWORD_LOGIN_001() {
		...
		driver.findElement(By.xpath(loc.getProperty("your_password_GM_LF_001")))
				.sendKeys((loc.getProperty("enter_your_password_GM_LF_003")));
