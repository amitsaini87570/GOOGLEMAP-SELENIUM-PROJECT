...
public class TC_SF_002_SEARCH_FUNCTIONALITY2 extends GM_BASE_CLASS {
	@Test
	public void search_NON_existing_location_gm_sf_001() {

		driver.manage().window().maximize();

		// ENTER LOCATION NAME
		driver.findElement(By.xpath(loc.getProperty("search_box_gm_sf_001")))
				.sendKeys((loc.getProperty("enter_search_box_gm_sf_002")));
