...
public class TC_FP_010_FORGOT_PASSWORD_FUNCTIONALITY3 extends GM_BASE_CLASS {
	...
	@Test
	public void validate_ui_fp_010() throws IOException, MailosaurException {
		...
		driver.findElement(By.xpath(loc.getProperty("confirm_password_gm_fp_013")))
				.sendKeys((loc.getProperty("enter_confirm_password_gm_fp_013")));
		...
		WebElement scroll1 = driver.findElement(By.xpath(loc.getProperty("scroll_to_continue_fp_gm_013")));
		js.executeScript("arguments[0].scrollIntoView(true)", scroll1);

		// click on continue
		driver.findElement(By.xpath(loc.getProperty("click_on_continue_gm_fp_013"))).click();

		// Proper and good UI are displayed on the 'forgot password' page.
