...
public class TC_FP_005_FORGOT_PASSWORD_FUNCTIONALITY3 extends GM_BASE_CLASS {
	...
	@Test
	public void validate_title_url_fp_005() throws IOException, MailosaurException {
		...
		String expected_title10 = (loc.getProperty("expected_title_gm_fp_005"));
		// verifying the title
		...
		String expected_url10 = (loc.getProperty("expected_url10__gm_fp_005"));
		// verifying the url
