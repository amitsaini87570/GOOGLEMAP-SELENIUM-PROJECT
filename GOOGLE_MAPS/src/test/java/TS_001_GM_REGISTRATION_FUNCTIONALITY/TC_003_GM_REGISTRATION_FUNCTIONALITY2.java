...
public class TC_003_GM_REGISTRATION_FUNCTIONALITY2 extends GM_BASE_CLASS {

	@Test
	public void existing_account_email_gm_rf_003() {
		...
		driver.findElement(By.xpath(loc.getProperty("email_username_gm_rf_001")))
				.sendKeys((loc.getProperty("enter_email_gm_rf_003")));
