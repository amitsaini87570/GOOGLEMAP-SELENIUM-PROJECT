...
public class TC_GM_004_CHANGE_PASSWORD2 extends GM_BASE_CLASS {
	@Test
	public void VALIDATE__enter_different_password_001() {
		...
		driver.findElement(By.xpath(loc.getProperty("confirm_new_passwordGM_LF_012")))
				.sendKeys((loc.getProperty("enter_confirm_new_passwordGM_cp_004")));
