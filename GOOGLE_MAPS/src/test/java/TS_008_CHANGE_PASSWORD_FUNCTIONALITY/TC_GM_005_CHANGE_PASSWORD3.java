...
public class TC_GM_005_CHANGE_PASSWORD3 extends GM_BASE_CLASS {
	@Test
	public void VALIDATE_mandotry_symbolCHANGE_PASSWORD_PAGE_005() {
		...
		// click on password
		driver.findElement(By.xpath(loc.getProperty("password_change_GM_LF_0120"))).click();
	}
