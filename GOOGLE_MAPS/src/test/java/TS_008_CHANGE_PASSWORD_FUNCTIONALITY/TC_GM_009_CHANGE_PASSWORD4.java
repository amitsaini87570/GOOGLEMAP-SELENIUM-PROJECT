...
public class TC_GM_009_CHANGE_PASSWORD4 extends GM_BASE_CLASS {
	@Test
	public void VALIDATE_supported_env_CHANGE_PASSWORD_FUNCTIONALITY_008() {
		/*
		...
		//enter password
			...
			//  'change password page' functionality is working in all the supported environments
