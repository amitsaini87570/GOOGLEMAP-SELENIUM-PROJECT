...
public class TC_LDP_014_gm_location_display_functionality4 extends GM_BASE_CLASS {
	@Test
	public void Validate_images_gm_ldp_014() {
...
//click button
		...
		// CLICK ON IMAGES
		driver.findElement(By.xpath(loc.getProperty("click_on_images_gm_ldp_014"))).click();
