...
public class TC_LDP_008_gm_location_display_functionality4 extends GM_BASE_CLASS {
	@Test
	public void Validate_without_enter_start_point_tc_gm_ldp_008() {
...
//click button
		...
		// click on start LOCATION NAME
		driver.findElement(By.xpath(loc.getProperty("start_location_gm_ldp_007"))).click();
